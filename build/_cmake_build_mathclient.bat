...
echo Generating makefiles by executing: cmake ..
cmake ..
if %errorlevel% neq 0 echo. && echo Error - Failure during execution of: cmake .. && echo Failed generating makefiles for: MathClient && echo. && pause && exit /b 1
